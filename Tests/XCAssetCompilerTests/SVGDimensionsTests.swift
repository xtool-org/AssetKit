...
struct SVGDimensionsTests {
    ...
    func widthHeightWin() throws {
        ...
        """.utf8)
        let dims = try SVGDimensions.read(svg, asset: "X", filename: "x.svg")
    ...
    func viewBoxOnly() throws {
        ...
        """.utf8)
        let dims = try SVGDimensions.read(svg, asset: "SampleVector", filename: "sample.svg")
    ...
    func missingDimsThrows() {
        ...
        #expect(throws: XCAssetCompilerError.self) {
            _ = try SVGDimensions.read(svg, asset: "X", filename: "x.svg")
        }
    }
}
